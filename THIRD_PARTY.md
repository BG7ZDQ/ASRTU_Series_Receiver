...
| Inno Setup Chinese Simplified and Japanese messages | https://github.com/jrsoftware/issrc | Inno Setup License; `packaging/inno/Languages/ChineseSimplified.isl` and `packaging/inno/Languages/Japanese.isl` are pinned with the same 6.4.3 release so the installer does not depend on language files installed alongside ISCC |
